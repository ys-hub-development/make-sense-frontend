...
import { GeneralActionTypes, ImageActionType, ProjectData } from './types';
...
export function updateProjectAuth(isAuth: boolean): GeneralActionTypes {
  return {
    type: Action.UPDATE_PROJECT_AUTH,
    payload: {
      isAuth,
    },
  };
...
export function updateImageActionType(
  actionType: ImageActionType
): GeneralActionTypes {
  return {
    type: Action.UPDATE_IMAGE_ACTION_TYPE,
    payload: {
      type: actionType,
    },
  };
