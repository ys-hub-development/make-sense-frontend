...
export type GeneralState = {
  ...
  zoom: number;
  isAuth: boolean;
  imageActionType: ImageActionType | null;
};
...
interface UpdateIsAuth {
  type: typeof Action.UPDATE_PROJECT_AUTH;
  payload: {
    isAuth: boolean;
  };
}

interface UpdateImageActionType {
  type: typeof Action.UPDATE_IMAGE_ACTION_TYPE;
  payload: {
