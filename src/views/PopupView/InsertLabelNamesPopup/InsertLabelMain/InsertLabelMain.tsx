...
interface IProps {
  ...
  updatePerClassColorationStatusAction: (updatePerClassColoration: boolean) => void;
  ...
  const labelInputs = labelNames.map((labelName: LabelName) => {
    ...
    return <div className='LabelEntry' key={labelName.id}>
      ...
      {projectType === ProjectType.OBJECT_DETECTION && enablePerClassColoration &&
        ...
        />}
      <ImageButton
        image={'ico/description.png'}
        imageAlt={'description_label'}
        buttonSize={{ width: 30, height: 30 }}
        onClick={() => setLabelId(labelName.id)}
      />
      <ImageButton
        image={'ico/trash.png'}
